		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestor de DataLake",
									"targetURL": "#cohainadatalakemanagerapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cohainadatalakemanagerapp-display": {
								"semanticObject": "cohainadatalakemanagerapp",
								"action": "display",
								"description": "Gestor de DataLake",
								"title": "Gestor de DataLake",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=co.haina.datalakemanagerapp",
									"url": sap.ui.require.toUrl("co/haina/datalakemanagerapp")
								}
							}
						}
					}
